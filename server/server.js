...
// ============================================================================
// 🤖 PRODUCTION AI CHAT ENDPOINT (WITH ROBUST MODEL FALLBACKS)
// ============================================================================
...
// Secure Multi-Agent Multi-Turn Automation Route
app.post('/api/ai/execute-automation', async (req, res) => {
    try {
        ...
        const chat = model.startChat({
            history: chatHistory,
            systemInstruction: "You are the VSCodium core workbench executor loop, a high-performance automation agent designed to seamlessly generate multi-turn code improvements, database migrations, and authentication flows."
        });
